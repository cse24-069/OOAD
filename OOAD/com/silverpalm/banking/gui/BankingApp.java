...
public class BankingApp extends Application {
    ...
    public static void showTellerDash() {
        root.getChildren().clear();
        String tellerId = com.silverpalm.banking.core.service.BankingService
                .getInstance()
                .getBankTeller()
                .getTellerId();
        var view = new com.silverpalm.banking.gui.view.TellerDashboardView(tellerId);
    ...
    public static void showDepositDialog(String customerId) {
        new com.silverpalm.banking.gui.view.DepositDialog(customerId).showAndWait();
    }
    public static void showWithdrawDialog(String customerId) {
        new com.silverpalm.banking.gui.view.WithdrawDialog(customerId).showAndWait();
    }
    public static void showTransactionHistory(String customerId) {
        new com.silverpalm.banking.gui.view.TransactionHistoryDialog(customerId).showAndWait();
    }
    public static void showCustomerProfile(String customerId) {
        new com.silverpalm.banking.gui.view.CustomerProfileDialog(customerId).showAndWait();
    }
}
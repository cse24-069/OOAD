...
public class DepositDialog extends Stage {
    public DepositDialog(String customerId) {
        setTitle("Deposit – " + customerId);
        ...
        Button btnOk   = new Button("Deposit");
        ...
        btnOk.setOnAction(e -> {
            try {
                BankingService.getInstance().deposit(txtAcc.getText(), Double.parseDouble(txtAmt.getText()));
